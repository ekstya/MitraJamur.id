        ...
        <div class="card shadow-2-strong" style="border-radius: 2rem; background-color:#91C788">
          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="form-outline mb-4">
              <input type="text" id="typeUsername" class="form-control form-control-lg" placeholder="Email" required/>
            </div>
            ...
            <a href="" class="btn btn-success btn-outline-light btn-lg btn-block mt-4 mb-5" type="submit">Login</a>

            <h5>Haven't an account? <span class="log"><a href="/register"> Register Here</a></span></h5>
          </div>
        </div>
      </div>
    </div>
