...
<div class="container-fluid">
    <div class="button-row" >
        <a href="/addProduct" class="btn btn-success btn-md mt-2 mb-5"  role="button" style="border-radius: 1rem;" ><i class="bi bi-plus" aria-hidden="true"></i><b>  Tambah</b></a>
    </div>
                ...
                <div class="col mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 " style="background-color: #A3DA8D;">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/editProduct">Edit</a></div>
                        </div>
                    </div>
                </div>
