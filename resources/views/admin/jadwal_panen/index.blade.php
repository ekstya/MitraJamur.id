    ...
    <div id="grid4" class="p-4">
        <div class="grid grid-cols-1 gap-4 bg-[#519259] mb-4">
            <div class="text-center text-xl text-white font-medium p-3">
                <h1>Data Jadwal Panen</h1>
            </div>
        </div>
        <a href="/admin/jadwal_panen/create" class="bg-[#04936d] px-2 py-1 rounded-lg text-white text-lg font-medium"><i class="fa-solid fa-plus"></i> Tambah Jadwal</a>
        <br>
        <br>
        <div class="container">
            <div class="row">
                    ...
                    <table class="table-auto w-full bg-white">
                        <thead>
                            <tr class="border-b-black border border-transparent">
                                ...
                                <th class="py-3">Jumlah Baglog</th>
                                <th class="py-3">Musim</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b-black border border-transparent">
                                ...
                                <td class="text-center py-3">{{$dt->tanggalMulai}}</td>
                                <td class="text-center py-3">{{$dt->jumlahBaglog}}</td>
