...
<body>
    ...
    <div id="grid4" class="p-4">
        <a href="/admin/workshop" class="bg-[#04936d] px-3 py-1 rounded-full text-white text-lg font-medium"><i class="fa-solid fa-circle-left"></i> Back</a>
        <div class="px-10 mt-10 max-h-[80%]">
            <form action="/admin/workshop/update/{{$data->id}}" method="post" enctype="multipart/form-data">
            @csrf    
            <div class="grid grid-cols-1 gap-4 bg-[#519259]">
                    <div class="text-center text-xl text-white font-medium p-3">
                        <h1>Mengubah Data Workshop</h1>
                    </div>
                </div>
                <div class="serif grid grid-cols-4 gap-4 bg-white">
                    <div class="pl-3 pt-3">
                        Foto Workshop<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="file" accept="image/*" class="border w-full border-black rounded-lg p-1" name="gambarWorkshop">
                    </div>
                    <div class="pl-3 pt-3">
                        Nama Workshop<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="text" class="border w-full border-black rounded-lg p-1" name="namaWorkshop" value="{{$data->namaWorkshop}}" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Waktu<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="date" class="border w-full border-black rounded-lg p-1" name="waktuWorkshop" value="{{$data->waktuWorkshop}}" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Harga<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="number" class="border w-full border-black rounded-lg p-1" name="hargaWorkshop" value="{{$data->hargaWorkshop}}" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Deskripsi
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <textarea name="deskripsiWorkshop" id="" cols="2" class="border w-full border-black rounded-lg p-1">{{$data->deskripsiWorkshop}}</textarea>
                    </div>
                    <div></div>
                    <div class="pr-3 col-span-3">
