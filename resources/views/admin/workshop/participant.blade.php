                                ...
                                <tbody>
                                    ...
                                    @if ($data != null)
                                        ...
                                        <tr class="border-b-black border border-transparent">
                                            ...
                                            <td class="text-center py-3">{{$dt->pendaftaran->user->namaUser}}</td>
                                            <td class="text-center py-3">{{$dt->pendaftaran->user->email}}</td>
                                            <td class="text-center py-3">{{$dt->pendaftaran->user->noHp}}</td>
                                        </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td class="border-b-black border border-transparent">
                                                Data Kosong
                                            </td>
                                        </tr>
                                    @endif
