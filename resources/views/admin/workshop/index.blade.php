...
<body>
    ...
    <div id="grid4" class="p-4">
        <a href="/admin/workshop/create" class="bg-[#04936d] px-2 py-1 rounded-lg text-white text-lg font-medium"><i class="fa-solid fa-plus"></i> Tambah</a>
        <div class="serif mt-10 overflow-scroll max-h-[80%]">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center ">
                ...
                <div class="relative mb-5 bg-[#a3da8d] p-2 w-[15rem] text-center">
                    <img src="{{ asset('foto-workshop/'.$dt->gambarWorkshop) }}" class="h-[11rem] w-full">
