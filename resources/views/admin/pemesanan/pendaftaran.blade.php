                            ...
                            <table class="table-auto w-full bg-white">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b-black border border-transparent">
                                        ...
                                        <td class="text-center py-3">{{$dt->tanggalPembayaran}}</td>
                                        <td class="text-center py-3">{{$dt->statusPembayaran}}</td>
                                        <td class="text-center py-3">
                                            @if($dt->statusPembayaran == 'MenungguKonfirmasi')
                                            <a href="/admin/pemesanan/pendaftaran/konfirmasi/{{$dt->pendaftaran_workshop_id}}" class="bg-[#DEDA08] px-2 py-1 rounded-lg text-black text-sm font-medium"><i class="fa-solid fa-file"></i> Konfirmasi</a>
                                            @endif
                                            @if($dt->statusPembayaran == 'BelumBayar')
                                            <p>Menunggu Pembayaran...</p>
                                            @endif
                                            @if($dt->statusPembayaran == 'Ditolak')
                                            <p>Selesai</p>
                                            @endif
                                            @if($dt->statusPembayaran == 'Dikonfirmasi')
                                            <p>Selesai</p>
                                            @endif
                                        </td>
                                    </tr>
