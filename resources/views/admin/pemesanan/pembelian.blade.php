                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b-black border border-transparent">
                                        ...
                                        <td class="text-center py-3">
                                            ...
                                            <a href="/admin/pemesanan/pembelian/konfirmasi/{{$dt->pembelian_id}}" class="bg-[#DEDA08] px-2 py-1 rounded-lg text-black text-sm font-medium"><i class="fa-solid fa-file"></i> Konfirmasi</a>
                                            @endif
