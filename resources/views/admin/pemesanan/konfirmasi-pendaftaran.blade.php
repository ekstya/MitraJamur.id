...
<body>
    ...
    <div id="grid4" class="p-4">
        <div class="serif overflow-scroll max-h-[95%]">
            ...
            <a href="/admin/pemesanan/pendaftaran" class="bg-[#04936d] px-3 py-1 rounded-full text-white text-lg font-medium mt-2"><i class="fa-solid fa-circle-left"></i> Back</a>
                    ...
                    <div class="row">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-items-left ">
                            <div class="col-md-3" align="center">
                                <img src="{{ asset('bukti-workshop/'.$bukti->bukti) }}" width="70%;" height="auto">
                            </div>
                            <div class="col-md-9" align="left">
                                <p class="font-bold my-2" style="font-size:36px;">{{$data->namaWorkshop}}</p>
                                <p class="my-2 text-center" style="font-size:28px; font-family:Comic Sans MS;">Pendaftar: {{$data->namaUser}}</p>
                                <p class="my-2 text-center" style="font-size:28px; font-family:Comic Sans MS;">Rp{{number_format($data->hargaWorkshop)}}</p>
                                <p class="my-2 text-center" style="font-size:24px; font-family:Comic Sans MS;">Tanggal beli:{{$data->tanggalPembayaran}}</p>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-items-left ">
                                    <form action="/admin/pemesanan/pendaftaran/konfirmasi/{{$data->pendaftaran_workshop_id}}/terima/post" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="text-center mt-5">
                                            <button type="submit" class="bg-[#076192] px-2 py-1 rounded-lg text-white text-xl font-medium">Terima</button>
                                        </div>
                                    </form>
                                    <form action="/admin/pemesanan/pendaftaran/konfirmasi/{{$data->pendaftaran_workshop_id}}/tolak/post" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="text-center mt-5">
