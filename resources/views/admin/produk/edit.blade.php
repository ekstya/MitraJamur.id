...
<body>
    ...
    <div id="grid4" class="p-4">
        ...
        <div class="px-10 mt-10 max-h-[80%]">
            <form action="/admin/produk/update/{{$data->id}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="serif grid grid-cols-4 gap-4 bg-white">
                    ...
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="file" accept="image/*" class="border w-full border-black rounded-lg p-1" name="gambarProduk">
                    </div>
                    <div class="pl-3 pt-3">
                        Nama Produk<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="text" class="border w-full border-black rounded-lg p-1" name="namaProduk" value="{{$data->namaProduk}}" required>
                    </div>
                    <div class="pl-3 pt-3">
                    ...
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="number" class="border w-full border-black rounded-lg p-1" name="stokProduk" value="{{$data->stokProduk}}" required>
                    </div>
                    <div></div>
