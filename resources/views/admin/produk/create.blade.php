...
<body>
    ...
    <div id="grid4" class="p-4">
        <a href="/admin/produk" class="bg-[#04936d] px-3 py-1 rounded-full text-white text-lg font-medium"><i class="fa-solid fa-circle-left"></i> Back</a>
        <div class="px-10 mt-10 max-h-[80%]">
            <form action="/admin/produk/insert" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="serif grid grid-cols-4 gap-4 bg-white">
                    ...
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="file" accept="image/*" class="border w-full border-black rounded-lg p-1" name="gambarProduk" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Nama Produk<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="text" class="border w-full border-black rounded-lg p-1" name="namaProduk" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Harga<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <input type="number" class="border w-full border-black rounded-lg p-1" name="hargaProduk" required>
                    </div>
                    <div class="pl-3 pt-3">
                        Deskripsi
                    </div>
                    <div class="pr-3 pt-2 col-span-3">
                        <textarea name="deskripsiProduk" id="" cols="2" class="border w-full border-black rounded-lg p-1"></textarea>
                    </div>
                    <div class="pl-3 pt-3">
                        Stok<span class="text-red-600">*</span>
                    </div>
                    <div class="pr-3 pt-2 pb--2 col-span-3">
                        <input type="number" class="border w-full border-black rounded-lg p-1" name="stokProduk" required>
                    </div>
                    <div></div>
