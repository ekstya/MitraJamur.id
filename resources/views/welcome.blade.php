...
<body>
    <div id="grid1">
    <h1 class="text-white text-2xl font-bold text-center mt-5"><a href="/">MitraJamur.Id</a></h1>
    </div>
    <div id="grid2">
        <a href="/login" class="text-white text-2xl float-right mr-7 mt-5"> Workshop</a>
        <a href="/login" class="text-white text-2xl float-right mr-7 mt-5"> Produk</a>
    </div>
    <div id="grid3" class="p-4">
        <div class="serif overflow-scroll max-h-[95%]">
            <div class="w-full bg-[#a3da8d]">
                <div class="grid grid-cols-3 place-items-center py-5">
                    <div class="col-span-2 ml-20">
                        ...
                        <a href="/login" class="ml-10 mt-5 px-7 py-3 bg-[#04936d] text-white">Login</a>
                        <a href="/register" class="ml-5 mt-5 px-7 py-3 border border-black">Register <i class="fa-solid fa-right-long"></i></a>
                    </div>
                    <div>
                        <center>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-items-center mb-4">
