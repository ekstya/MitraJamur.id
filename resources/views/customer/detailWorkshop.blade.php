...
<div class="container-xl">
    <div class="row row-cols-2 g-4 row-cols-md-2 mt-4 mb-4">
        ...
        <div class="main-detail" style="padding-left: 30px;">
            ...
            <div class="button-row" >
                <a href="#" class="btn btn-success btn-md mt-4 mb-4"  role="button" style="border-radius: 1rem;" ><i class="bi bi-cart-dash-fill" aria-hidden="true"></i><b>  Daftar Sekarang</b></a>
            </div>
        </div>
    </div>
</div>
