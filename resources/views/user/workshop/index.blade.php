...
<body>
    ...
    <div id="grid2">
        ...
        <a href="/user/workshop" class="text-black text-xl float-right ml-5 mr-5 mt-5"> Workshop</a>
        ...
        <div class="serif overflow-scroll max-h-[95%]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-items-center mt-5">
                ...
                <div class="relative mb-5 bg-[#f4f4f4] p-2 w-[15rem] text-center">
                    ...
                    <p class="my-2 mb-4">Rp{{number_format($wsp->hargaWorkshop)}}</p>
                    <a href="/user/workshop/detail/{{$wsp->id}}" class="border border-black px-3">View More</a>
                </div>
                @endforeach
            </div>
        </div>
