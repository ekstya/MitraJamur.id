...
<div id="grid1">
    ...
    <div id="grid3" class="p-4">
        ...
        <a href="/user/produk" class="bg-[#04936d] px-3 py-2 rounded-full text-white text-lg font-medium mt-2 ml-10"><i class="fa-solid fa-circle-left"></i> Back</a>
                ...
                <div class="row">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-items-left ml-20">
                        <div class="col-md-3" align="center">
                            <img src="{{ asset('foto-produk/'.$data->gambarProduk) }}" width="70%;" height="auto">
                        </div>
                        <div class="col-md-9" align="left">
                            <p class="font-bold my-2 text-center" style="font-size:36px;">{{$data->namaProduk}}</p>
                            <p class="my-2 text-center" style="font-size:20px;">Rp{{number_format($data->hargaProduk)}}</p>

                            <p class="font-medium my-2 mt-8" style="font-size:15px;">{{$data->deskripsiProduk}}</p>
                            <p class="my-2 text-left mt-7 mb-2" style="font-size:20px;">Stok: {{$data->stokProduk}}</p>
                            <form action="/user/produk/pesan/{{$data->id}}" method="post">
                                @csrf
