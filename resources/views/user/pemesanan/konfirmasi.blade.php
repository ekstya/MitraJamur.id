...
<body>
    ...
    <div id="grid3" class="p-4">
        <div class="serif overflow-scroll max-h-[95%]">
            ...
            <a href="/user/pemesanan" class="bg-[#04936d] px-3 py-2 rounded-full text-white text-lg font-medium mt-2 ml-10"><i class="fa-solid fa-circle-left"></i> Back</a>
                    ...
                    <div class="row">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-items-left ml-20 ">
                            ...
                            <div class="col-md-9" align="left">
                                ...
                                <p class="my-2 text-left mb-5">Pembayaran dapat melalui :<br>
                                - Gopay : 089643321355 <br>
                                - BNI : 09457812
                                </p>

                                <form action="/user/pemesanan/konfirmasi/{{$data->pembelian_id}}/post" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="pl-3 pt-3 font-bold">
                                        Konfirmasi Pembayaran
                                    </div>
                                    <div class="pr-3 pt-2 col-span-3">
                                        <input type="hidden" value="{{date('Y-m-d')}}" name="tanggalPembayaran">
                                        <input type="hidden" name="pembayaran_pembelian_id" value="{{$data->pembelian_id}}">
