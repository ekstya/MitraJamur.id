...
<div id="grid1">
    ...
    <div id="grid2">
        ...
        <a href="/user/pemesanan" class="text-black text-xl float-right ml-5 mr-5 mt-5"> Pemesanan</a>
        ...
        <div class="serif overflow-scroll max-h-[95%]">
            ...
            <div class="serif mt-10 overflow-scroll max-h-[80%]">
                <div class="container text-center justify-items-center ml-20 mr-20">
                    <div class="row">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 justify-items-center text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b-black border border-transparent">
                                        ...
                                        <td class="text-center py-3">
                                            ...
                                            <a href="/user/pemesanan/konfirmasi/{{$dt->pembelian_id}}" class="bg-[#DEDA08] px-2 py-1 rounded-lg text-black text-sm font-medium"><i class="fa-solid fa-file"></i> Konfirmasi</a>
                                            @endif
